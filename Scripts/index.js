...
$(document).ready(function () {
  ...
  fetch("https://api.github.com/users/JosephLteif")
    ...
    .then((data) => {
      ...
      $("#GitHubFollowbtn").attr(
        "onclick",
        "window.location.href='" + data.html_url + "'"
      );
      $("#GitHubProfilePicture").html(
        '<picture><img id="GitHubImportedImage" src=' +
          data.avatar_url +
          " alt=" +
          "></picture>"
      );
  ...
  if ($(window).width() <= 800 && $("#PersonalInfo").hasClass("col")) {
    $("#PersonalInfo").removeClass("col");
    $("#ImageDiv").removeClass("col");
  }

  if ($(window).width() > 800 && !$("#PersonalInfo").hasClass("col")) {
    $("#PersonalInfo").addClass("col");
