    ...
    <section id="hero" className="hero">
      <div className="hero-content">
        ...
        <div className="hero-actions">
          <a href="https://drive.google.com/file/d/1CneY60Or7FrVN2CfXPUJ6nLVVQCZfCdT/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="button primary">View Resume</a>
        </div>
      </div>
    </section>
  );
